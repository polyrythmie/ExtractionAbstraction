...
,
					...
					"patching_rect" : [ 714.0, 441.0, 150.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 662.0, 664.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "send~ IN2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 654.0, 635.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "send~ IN1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 570.0, 310.0, 100.0, 22.0 ],
									"style" : "",
									"text" : "buddy"
								}
...
,
					"patching_rect" : [ 361.0, 255.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 361.0, 227.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 662.0, 96.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "8467"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 445.0, 96.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "5292"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 165.5, 300.0, 39.0, 32.0 ],
									"style" : ""
								}
...
, 			{
				"box" : 				{
					...
					"save" : [ "#N", "qlist", ";", "#X", "insert", "EQ", 1, ";", ";", "#X", "insert", "LEVELS", 1, ";", ";", "#X", "insert", "REVERB", 1, ";", ";", "#X", "insert", 19110, ";", ";", "#X", "insert", 12160, ";", ";", "#X", "insert", "EQ", 2, ";", ";", "#X", "insert", "PAN", 1, ";", ";", "#X", "insert", "REVERB", 2, ";", ";", "#X", "insert", 2950, ";", ";", "#X", "insert", "RECORDING1", "START", ";", ";", "#X", "insert", 69780, ";", ";", "#X", "insert", "PAN", 2, ";", ";", "#X", "insert", "LEVELS", 2, ";", ";", "#X", "insert", "EQ", 3, ";", ";", "#X", "insert", 5040, ";", ";", "#X", "insert", "LEVELS", 3, ";", ";", "#X", "insert", 10210, ";", ";", "#X", "insert", "RECORDING1", "STOP", ";", ";" ],
					"style" : "",
					"text" : "qlist"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "bang", "bang", "bang", "" ],
									"patching_rect" : [ 105.0, 60.0, 135.0, 22.0 ],
									"style" : "",
									"text" : "sel 1 2 3"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "bang", "bang", "bang", "" ],
									"patching_rect" : [ 450.0, 75.0, 100.0, 22.0 ],
									"style" : "",
									"text" : "sel 1 2 3"
								}
